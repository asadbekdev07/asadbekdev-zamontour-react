...
const Visit = () => {
  ...
  const visitData = [
    { img: dubai, city: t('city.1'), country: t('uae'), description: t('dubaidesc'), population: " 3.3 million", territory: " 35km²", avgPrice: " $425.000" },
    { img: antalya, city: t('city.2'), country: t('turkey'), description: t('antalyadesc'), population: " 1.5 million", territory: " 1.417 km²", avgPrice: " $1.100.200" },
    { img: sharm, city: t('city.3'), country: t('egypt'), description: t('sharmdesc'), population: " 0.07 million", territory: " 45km²", avgPrice:" $165.45" },
    { img: istanbul, city: t('city.0'), country: t('turkey'), description: t('istanbuldesc'), population: " 15.5 million", territory: " 5.461 t('km')", avgPrice: " $946.000" }
  ];
