        ...
        <div className="forms__container">
          <form id="form__reservation" name="form" method="post" action="#">
            ...
            <fieldset className="form__column">
              ...
              <select name="country" className="form__field" aria-label="Default select example" id="visa">
            ...
            <fieldset>
              <button type="submit" className="button button--form">Make Your Reservation Now</button>
            </fieldset>
          </form>
        </div>
      </div>
