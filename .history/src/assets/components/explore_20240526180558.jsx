      ...
      <div className="container">
        ...
        <ul className="explore__list">
                          ...
                          <li className="explore__item">
                            <img className="explore__img" src={afrasiab} alt="Airplane img" width="340" height="228">
                          ...
                          <li className="explore__item">
                            <img className="explore__img" src="img/airplane.jpg" alt="Airplane img" width="340" height="228">
                            <div className="explore__inner">
