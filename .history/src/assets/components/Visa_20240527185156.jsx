...
const Visa = () => {
  ...
  const offersData = [
    { img: china, city: t('china'), checkIns: 274 },
    { img: hongkong, city: t('hong'), checkIns: 350 },
    { img: europe, city: t('schengen'), checkIns: 453 },
    { img: india, city: t('india'), checkIns: 220 },
    { img: japan, city: t('japan'), checkIns: 442 },
    { img: saudi, city: t('saudia'), checkIns: 424 },
    { img: oman, city: t('oman'), checkIns: 389 }
  ];
    ...
    <div className="visa" id='about'>
      <div className="container">
        <div className="visa__content">
          <h2 className="visa__title">{t('visa')}</h2>
          <p className="visa__description">{t('visadesc')}</p>
        </div>
        <Swiper
            ...
            <SwiperSlide key={index} className='visa__card'>
              ...
              <div className="visa__card-inner inner">
                ...
                <ul className='inner__list'>
                  <li className="inner__list-title">{t('benefits')}</li>
                  <li><i className="fa fa-tags"></i> {t('best')}</li>
                  <li><i className="fa fa-clock"></i> {t('short')}</li>
                  <li><i className="fa fa-check"></i> {t('trust')}</li>
                </ul>
