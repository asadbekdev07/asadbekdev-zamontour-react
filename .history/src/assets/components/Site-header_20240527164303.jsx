          ...
          <ul className="lang">
            ...
            <ul className="lang">
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'en' ? 'selected' : ''}`} onClick={() => handleChange('en')}>EN</a>
              </li>
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'uz' ? 'selected' : ''}`} onClick={() => handleChange('uz')}>UZ</a>
              </li>
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'ru' ? 'selected' : ''}`} onClick={() => handleChange('ru')}>RU</a>
              </li>
            </ul>
