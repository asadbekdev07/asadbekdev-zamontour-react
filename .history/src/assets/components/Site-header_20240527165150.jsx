          ...
          <ul className="lang">
            ...
            <ul className="lang">
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'en' ? 'selected' : ''}`} onClick={() => changeLanguage('en')}>EN</a>
              </li>
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'uz' ? 'selected' : ''}`} onClick={() => changeLanguage('uz')}>UZ</a>
              </li>
              <li className='lang__item'>
                <a className={`lang__link ${i18n.language === 'ru' ? 'selected' : ''}`} onClick={() => changeLanguage('ru')}>RU</a>
              </li>
            </ul>
