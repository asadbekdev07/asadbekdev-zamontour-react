          ...
          <ul className="lang">
            <li className="lang__item">
              <a
                ...
                href="#"
                onClick={(e) => { e.preventDefault(); handleChangeLanguage('en'); }}
              >
                EN
              </a>
            </li>
            <li className="lang__item">
              <a
                ...
                href="#"
                onClick={(e) => { e.preventDefault(); handleChangeLanguage('uz'); }}
              >
                UZ
              </a>
            </li>
            <li className="lang__item">
              <a
                ...
                href="#"
                onClick={(e) => { e.preventDefault(); handleChangeLanguage('ru'); }}
              >
                РУ
              </a>
            </li>
