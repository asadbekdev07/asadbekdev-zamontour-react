    ...
    <section className="location">
      <div className="container">
        ...
        <div className="location__cards">
          <div className="location__card" style={{backgroundImage: `url(${dubai})`}}>
          ...
          <div className="location__card" style={{backgroundImage: `url(${antalya})`}}>
            <div className="location__card-shadow"></div>
            <div className="location__card-label">
              <div className="location__card-icon">
                <i className="fa fa-expand"></i>
              ...
              <div className="location__card-info">
                  <div className="location__card-title">Antalya</div>
                  <div className="location__card-text">Population: 1.5 million</div>
              </div>
            </div>
          </div>
          <div className="location__card" style={{backgroundImage: `url(${istanbul})`}}>
            <div className="location__card-shadow"></div>
            <div className="location__card-label">
              <div className="location__card-icon">
                <i className="fa fa-expand"></i>
              ...
              <div className="location__card-info">
                  <div className="location__card-title">Istanbul</div>
                  <div className="location__card-text">Population: 15.5 million</div>
              </div>
            </div>
          </div>
          <div className="location__card" style={{backgroundImage: `url(${sharm})`}}>
            <div className="location__card-shadow"></div>
            <div className="location__card-label">
              <div className="location__card-icon">
                <i className="fa fa-expand"></i>
              ...
              <div className="location__card-info">
                  <div className="location__card-title">Sharm El-Sheik</div>
                  <div className="location__card-text">Population: 0.07 million</div>
              </div>
            </div>
          </div>
        </div>
